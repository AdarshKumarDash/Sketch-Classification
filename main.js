...
function updateCanvas() {
    ...
    document.getElementById("drawingimg").innerHTML = sketch;
}
...
function gotResult(error, result) {
    if (error) {
        ...
        document.getElementById("userimg").innerHTML = drawn_sketch;
